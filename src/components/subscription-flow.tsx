...
export default function SubscriptionFlow({ selectedPlanId }: { selectedPlanId: string }) {
  ...
  async function checkout(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const provider = String(new FormData(event.currentTarget).get("provider"));
